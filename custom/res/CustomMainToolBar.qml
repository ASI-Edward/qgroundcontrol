...
Rectangle {
    ...
    property string _gCSUsername:       _customFunction.getGCSUsername()
    property string _rCUsername:        _customFunction.getRCUsername()
    ...
    on_GCSUsernameChanged: {
        _gCSUsername = _customFunction.getGCSUsername()
        _rCUsername = _customFunction.getRCUsername()
    }
    ...
    ColumnLayout {
        ...
        visible:                _gCSUsername !== "" && _rCUsername !== ""
        spacing:                -2

        QGCLabel {
            id:             gCSULabel
            text:           "Mission Coordinator: " + _gCSUsername
        }

        QGCLabel {
            id:             rCULabel
            text:           "Pilot: " + _rCUsername
        }
    }
    ...
    QGCButton {
        ...
        text:                   qsTr("Logout")
        enabled:                true
        visible:                !popup.visible && !usernameError.visible
        onClicked:   {
            gCSText.text = ""
            rCText.text = ""
            if (_activeVehicle)
                _activeVehicle.closeVehicle()
            _customFunction.setGCSUsername("")
            _customFunction.setRCUsername("")
            _gCSUsername = ""
            _rCUsername = ""
            popup.open()
        }
